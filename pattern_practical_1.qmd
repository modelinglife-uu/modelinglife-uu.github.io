...
**Q1. (Algorithmic thinking)** Have a look at the reaction-diffusion
...
**Q2. (Important concept)** Play with the morphogen diffusion rate and
...
**Q3 (Biology & mathematical thinking)** Next, we are going to introduce
the genes A, B and C in the model. We want these genes to be expressed
dependent on M, and in the head, trunk and tail respectively, so A on
...
**Q4 (Biology & algorithmic/mathematical thinking)** From hereon we
...
**Q6 (Biology)** At some point in development, the morphogen gradient
...
**Q7 (Algorithmic/mathematical thinking)** Now write the code in
...
**Q8 Biological & mathematical thinking** A, B and C cannot remain in a
...
**Q9 (Biology & algorithmic/mathematical thinking)** A sudden switch
...
**Q10. Biology & algorithmic/mathematical thinking** Write code to get
...
#### [**Extra questions for if you're done early/ for master students. These questions need not be made in the order they are provided, you can choose what you would like to investigate.**]{.smallcaps}

**Q11 (Biological thinking)** Play with the size of the domain to see
what happens to the gene expression domains. What would this mean for an
organism?

**Q12 (Biological & algorithmic thinking)** Various mechanisms have been
...
**Q13 (Algorithmic thinking)** In b, we can also implement other
...
**Q14** From question 4 onwards, how do things change if we do not
...
**Q15** Implement your solution to make the system more robust for noise
