...
![Example of a σ field with four unique integer values. The value 0 is reserved for the medium, while the non-zero values represent three cells.](images/sigma_field.png)
...
![Equation 1.](images/acceptance.png)
...
Thus, we write:
![Equation 3.](images/perimeter.png)
