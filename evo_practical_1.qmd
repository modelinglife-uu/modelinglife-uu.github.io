...
!["Test"](https://upload.wikimedia.org/wikipedia/commons/0/0c/Tumbling_and_running_modes_associated_with_Escherichia_coli_and_Salmonella_typhimurium.png)
...
a. Determine the concentration of the position of the cell, AND the predicted position of the cell after a small timestep (hint: use $v_x$ and $v_y$ to predict the future position! **ask Bram if you get stuck**)
