...
1.  In practical 1 we saw how gradients can be created through local
...
2.  **Conceptual thinking** When would this type of gradient formation
...
3.  **Mathematics** Let us now move to the other half of the clock and
...
4.  **Biology** Play with the parameters of the model. How does the delay
...
5.  **Algorithmic thinking** In the file `rolling_clock.py`, there is a
...
6.  Next, we will combine the clock and FGF wavefront into a single
    ...
    2.  **Programming** As to not spoil the beans to students not
        wanting to code the model extension, since the hints for programming may
        answer above questions, please see instructions for
        implementing it yourself at the end of this tutorial.
