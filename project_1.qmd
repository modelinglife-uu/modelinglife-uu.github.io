...
![Figure 1. Vegetation patterns in semi-arid ecosystems. Depending on rainfall and terrain slope varies types of vegetation patterns may arise. Adjusted from Rietkerk et al., Science 2024. ](docs/images/vegetationFigure1.png){#vegmini1}


One of the models frequently used for these water-vegetation systems is described by the following set of 3 equations: 


![](docs/images/vegetationEq.png){#vegminieq}
