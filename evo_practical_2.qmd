...
```python
  ...
  probs = [f for f in fitness_values] + [no_reproduction_chance]
...
e. **Bonus question for motivated students** modify the code to include spatial structure in the population (e.g. proteins on a grid only competing with nearby proteins). 
:::
